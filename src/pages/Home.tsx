          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                ...
                >
                  {user ? 'Get Started' : 'Start Free Trial'} <ArrowRight className="ml-2" size={20} />
                </Button>
                <Button
                  variant="outline"
                  size="lg"
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="p-6 bg-white rounded-lg shadow-lg">
              ...
              <p className="text-gray-600">Create hyper-personalized marketing campaigns</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-600">
        <div className="container mx-auto max-w-7xl text-center">
          ...
          <Button
            ...
            onClick={handleMainAction}
          >
            {user ? 'Get Started' : 'Start Your Free Trial'} <ArrowRight className="ml-2" size={20} />
          </Button>
        </div>
      </section>
    </div>

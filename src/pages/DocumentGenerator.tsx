...
export function DocumentGenerator() {
  ...
  const handleGenerate = async (data: typeof formData) => {
    ...
    try {
      ...
      setDocument(content);
      setFormData(data); // Update form data with the current settings
  ...
  const handleLoadDocument = (content: string) => {
    setDocument(content);
  };
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            ...
            />
            {user && <DocumentHistory onLoadDocument={handleLoadDocument} />}
          </div>
